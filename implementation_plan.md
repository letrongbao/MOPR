...
> [!IMPORTANT]
> - Trọng tâm hiện tại của hệ thống là quản lý nội bộ. Vậy các "tin đăng" này sẽ được hiển thị cho ai xem?
...
- Xử lý các thao tác thêm, sửa, xóa, lấy danh sách bài đăng từ Firestore (collection `tin_dang`).

### Feature & UI (Quản lý tin đăng)
#### [MODIFY] `com/example/myapplication/features/home/HomeMenuActivity.java`
#### [MODIFY] `res/layout/activity_home_menu.xml`
- Thêm Card Menu "Quản lý tin đăng" vào màn hình trang chủ của chủ trọ.
...
- Truy cập vào app với role chủ trọ, kiểm tra xem có nút "Quản lý tin đăng" trên màn hình Home.
