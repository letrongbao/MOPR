...
public class HoaDon {
    ...
    public String getIdNguoiThue() { return idNguoiThue; }
    public void setIdNguoiThue(String idNguoiThue) { this.idNguoiThue = idNguoiThue; }
    public String getThangNam() { return thangNam; }
    public void setThangNam(String thangNam) { this.thangNam = thangNam; }
    public double getChiSoDienDau() { return chiSoDienDau; }
    public void setChiSoDienDau(double chiSoDienDau) { this.chiSoDienDau = chiSoDienDau; }
    public double getChiSoDienCuoi() { return chiSoDienCuoi; }
    public void setChiSoDienCuoi(double chiSoDienCuoi) { this.chiSoDienCuoi = chiSoDienCuoi; }
    public double getDonGiaDien() { return donGiaDien; }
    public void setDonGiaDien(double donGiaDien) { this.donGiaDien = donGiaDien; }
    public double getChiSoNuocDau() { return chiSoNuocDau; }
    public void setChiSoNuocDau(double chiSoNuocDau) { this.chiSoNuocDau = chiSoNuocDau; }
    public double getChiSoNuocCuoi() { return chiSoNuocCuoi; }
    public void setChiSoNuocCuoi(double chiSoNuocCuoi) { this.chiSoNuocCuoi = chiSoNuocCuoi; }
    public double getDonGiaNuoc() { return donGiaNuoc; }
    public void setDonGiaNuoc(double donGiaNuoc) { this.donGiaNuoc = donGiaNuoc; }
    public double getPhiRac() { return phiRac; }
    public void setPhiRac(double phiRac) { this.phiRac = phiRac; }
    public double getPhiWifi() { return phiWifi; }
    public void setPhiWifi(double phiWifi) { this.phiWifi = phiWifi; }
