...
public class ChiPhiRepository {
    ...
    public MutableLiveData<List<ChiPhi>> listAll() {
        MutableLiveData<List<ChiPhi>> data = new MutableLiveData<>();
        getScopedCollection()
                ...
                .addSnapshotListener((snapshot, e) -> {
                    ...
                    snapshot.forEach(doc -> {
                        ChiPhi cp = doc.toObject(ChiPhi.class);
                        cp.setId(doc.getId());
                        list.add(cp);
                    });
                    data.setValue(list);
    ...
    public void add(ChiPhi chiPhi, Runnable onSuccess, Runnable onFail) {
    ...
    public void update(ChiPhi chiPhi, Runnable onSuccess, Runnable onFail) {
