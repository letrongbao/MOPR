...
public class InvoiceWidgetProvider extends AppWidgetProvider {
    ...
    private void updateWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        if (user == null) {
            views.setTextViewText(R.id.tvWidgetInvoice, "Chưa đăng nhập");
        ...
        views.setTextViewText(R.id.tvWidgetInvoice, "Đang tải...");
        appWidgetManager.updateAppWidget(appWidgetId, views);
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                views.setTextViewText(R.id.tvWidgetInvoice, "Lỗi kết nối");
