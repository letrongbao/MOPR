...
<<<<<<< Updated upstream:app/src/main/java/com/example/myapplication/domain/NguoiThue.java
    private String idPhong;         // tham chiếu tới PhongTro.id
    private String idPhongCu;       // lưu lịch sử khi kết thúc hợp đồng
=======
    private String idPhong; // tham chiếu tới Room.id
    private String idPhongCu; // lưu lịch sử khi kết thúc hợp đồng
>>>>>>> Stashed changes:app/src/main/java/com/example/myapplication/domain/Tenant.java
...
=======
    private double tienPhong; // @Deprecated: dùng giaThue thay thế
    private double tienCoc_old; // @Deprecated: dùng tienCoc thay thế
    private boolean hienThiTienCocTrenInvoice = true;
>>>>>>> Stashed changes:app/src/main/java/com/example/myapplication/domain/Tenant.java
    ...
    private boolean hienThiGhiChuTrenInvoice = true;
...
=======
    public boolean isHienThiTienCocTrenInvoice() {
        return hienThiTienCocTrenInvoice;
    }

    public void setHienThiTienCocTrenInvoice(boolean hienThiTienCocTrenInvoice) {
        this.hienThiTienCocTrenInvoice = hienThiTienCocTrenInvoice;
    }
>>>>>>> Stashed changes:app/src/main/java/com/example/myapplication/domain/Tenant.java
...
=======
    ...
    public boolean isHienThiGhiChuTrenInvoice() {
        return hienThiGhiChuTrenInvoice;
    }

    public void setHienThiGhiChuTrenInvoice(boolean hienThiGhiChuTrenInvoice) {
        this.hienThiGhiChuTrenInvoice = hienThiGhiChuTrenInvoice;
    }
