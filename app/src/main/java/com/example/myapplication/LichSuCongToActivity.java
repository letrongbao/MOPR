...
import com.example.myapplication.repository.MeterReadingRepository;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class LichSuCongToActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lich_su_cong_to);
        ...
        adapter = new MeterReadingAdapter(new MeterReadingAdapter.OnActionListener() {
            ...
            public void onDelete(MeterReading reading) {
                new AlertDialog.Builder(LichSuCongToActivity.this)
                        .setTitle("Xác nhận xóa")
                        .setMessage("Xóa chỉ số kỳ " + safe(reading.getPeriod()) + "?")
                        .setPositiveButton("Xóa", (d, w) -> repository.delete(reading.getId(),
                                () -> runOnUiThread(() -> Toast.makeText(LichSuCongToActivity.this, "Đã xóa", Toast.LENGTH_SHORT).show()),
                                () -> runOnUiThread(() -> Toast.makeText(LichSuCongToActivity.this, "Xóa thất bại", Toast.LENGTH_SHORT).show())))
        ...
        fabThem.setOnClickListener(v -> hienDialogThemCongTo());
    }

    private void hienDialogThemCongTo() {
