...
public class ChiTietHopDongActivity extends AppCompatActivity {
    ...
    private NguoiThueRepository repository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repository = new NguoiThueRepository();
            ...
            db.collection("tenants")
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            NguoiThue contract = documentSnapshot.toObject(NguoiThue.class);
                            if (contract != null) {
    ...
    private void displayContractDetails(NguoiThue contract) {
        // Tên phòng
        if (tvTenPhong != null) {
